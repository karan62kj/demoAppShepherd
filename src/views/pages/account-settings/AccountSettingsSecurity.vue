...
<template>
  <VRow>
    ...
    <VCol cols="12" id="change-password-wrapper">
            ...
            <VRow>
              <VCol cols="12" md="6">
                ...
                <VTextField v-model="newPassword" :type="isNewPasswordVisible ? 'text' : 'password'"
                  ...
                  label="New Password" @click:append-inner="isNewPasswordVisible = !isNewPasswordVisible" />
              </VCol>
            ...
            <VCardText>
              <VForm @submit.prevent="() => { }">
                <VRow>
                  <!-- 👉 Choose API Key -->
                  <VCol cols="12">
                    <VSelect label="Choose the API key type you want to create"
        ...
        <VCardText class="d-flex flex-column gap-y-4">
          <div v-for="serverKey in serverKeys" :key="serverKey.key" class="bg-var-theme-background pa-4">
            ...
            <p class="text-base font-weight-semibold">
              ...
              <VIcon :size="18" icon="mdi-content-copy" class="cursor-pointer" />
            </p>
        ...
        <VTable class="text-no-wrap">
          ...
          <tbody>
            <tr v-for="device in recentDevices" :key="device.recentActivity">
              <td>
                <VIcon start :icon="device.deviceIcon.icon" :color="device.deviceIcon.color" />
                {{ device.browser }}
              </td>
              <td>{{ device.device }}</td>
